...
- either provide a unique use case for interop or duplicate an existing use case
  but using a different tool or framework with significant differences.
- contain a `README.md` file with instructions for running the example locally,
  an overview of what the code does, and instructions for how to use the app if
  applicable
