import { requestPasskeyAuthentication } from "sso-legacy/client/passkey";
import { base64UrlToUint8Array, unwrapEC2Signature } from "sso-legacy/utils";
import {
  type Address,
  concat,
  encodeAbiParameters,
...
import { BUNDLER_URL, L2_PUBLIC_CLIENT, ssoContracts, zksyncOsTestnet } from "../constants";
...
export async function sendTxWithPasskey(
  ...
  const nonce = await L2_PUBLIC_CLIENT.readContract({
